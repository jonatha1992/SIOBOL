    ...
    public class BEActa
    {
        ...
        void llenarParametrosEntrega()
        {
            Parametros = new ReportParameterCollection
            {
                ...
                new ReportParameter("Dia", entrega.FechaEntrega.Day.ToString()),
                new ReportParameter("Mes", entrega.FechaEntrega.ToString("MMMM")),
                new ReportParameter("Ano", entrega.FechaEntrega.Year.ToString()),
                new ReportParameter("Hora", entrega.FechaEntrega.ToShortTimeString()),
