...
{
    public partial class Form_Persona : KryptonForm
    {
        ...
        void AgregarInstructorBase() //agregar  instructor a la base de datos 
        {
            ...
            else //
            {
                if (VerificarCambiosInstructor())
                {
                    ...
                    if (result == DialogResult.Yes)
                    {
                        bLLInstructor.Actualizar(instructor);
                        personaSeleccionada = bLLInstructor.ListarObjeto(instructor);
                        MessageBox.Show("Se cambiaron los datos con exito", "Informaciòn", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                }
            }
        ...
        void HabilitarTextBox()
        {
            ...
            if (comboBoxTipoPersona.Text == "INSTRUCTOR")
            {
                ...
                textBoxNombreInstructor.Enabled = false;
                textBoxDniInstructor.Enabled = false;

            }
            else if (comboBoxTipoPersona.Text == "TESTIGO")
            {
                textBoxDniTestigo.Enabled = false;
            }
            else // si es descubridor o propietario
            {
                textBoxDniDescubridor.Enabled = false;
            }
        }
        void CargarGrilla()
        {
        ...
        void CargarDatos()
        {
            ...
            else if (comboBoxTipoPersona.Text == "TESTIGO")
            {
                ...
                textBoxNombreTestigo.Text = personaSeleccionada.NombreCompleto; textBoxDniTestigo.Text = personaSeleccionada.DNI;
